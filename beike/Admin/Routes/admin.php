    ...
    ->group(function () {
        ...
        Route::middleware('admin_auth:' . \Beike\Models\AdminUser::AUTH_GUARD)
            ->group(function () {
                ...
                //Jump
                Route::middleware('can:tax_rates_index')->get('jumps', [Controllers\JumpController::class, 'index'])->name('jumps.index');
                Route::middleware('can:tax_rates_index')->post('jumps', [Controllers\JumpController::class, 'store'])->name('jumps.store');
                Route::middleware('can:tax_rates_index')->put('jumps/{id}', [Controllers\JumpController::class, 'update'])->name('jumps.update');
                Route::middleware('can:tax_rates_index')->delete('jumps/{id}', [Controllers\JumpController::class, 'destroy'])->name('jumps.destroy');
